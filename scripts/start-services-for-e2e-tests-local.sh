...
DOCUMENT_MANAGEMENT_API_ENDPOINT_URL=http://localhost:9072 \
PRISON_API_ENDPOINT_URL=http://localhost:9270 \
COMMUNITY_API_ENDPOINT_URL=http://localhost:9081 \
DELIUS_INTEGRATION_ENDPOINT_URL=http://localhost:9082 \
ARN_API_ENDPOINT_URL=http://localhost:9071 \
GOTENBERG_ENDPOINT_URL=http://localhost:9091 \
POSTGRES_HOST=localhost:5432 \
POSTGRES_DBNAME=make_recall_decision \
POSTGRES_USERNAME=mrd_user \
POSTGRES_PASSWORD=secret \
SPRING_PROFILES_ACTIVE=dev,seed-test-data
