...
context('Make a recommendation - form validation', () => {
  ...
  it('Response to probation', () => {
    ...
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/response-to-probation`)
  ...
  it('Licence conditions', () => {
    ...
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/licence-conditions`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Alternatives tried', () => {
    ...
    cy.task('getRecommendation', { statusCode: 200, response: recommendationResponse })
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/alternatives-tried`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Indeterminate sentence', () => {
    ...
    cy.task('getRecommendation', { statusCode: 200, response: recommendationResponse })
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/is-indeterminate`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Extended sentence', () => {
    ...
    cy.task('getRecommendation', { statusCode: 200, response: recommendationResponse })
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/is-extended`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Custody status', () => {
    ...
    cy.task('getRecommendation', { statusCode: 200, response: recommendationResponse })
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/custody-status`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Vulnerabilities with RiskToSelf enabled', () => {
    ...
    cy.task('getRecommendation', { statusCode: 200, response: recommendationResponse })
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/vulnerabilities?flagRiskToSelfEnabled=1`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Vulnerabilities Details', () => {
    ...
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/vulnerabilities-details?flagRiskToSelfEnabled=1`)
  ...
  it('IOM', () => {
    ...
    cy.task('getRecommendation', { statusCode: 200, response: recommendationResponse })
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/iom`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Arrest issues', () => {
    ...
    cy.task('getRecommendation', { statusCode: 200, response: recommendationResponse })
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/arrest-issues`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Add a previous recall', () => {
    ...
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/add-previous-recall`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
  ...
  it('Trigger leading to recall', () => {
    ...
    cy.task('getRecommendation', { statusCode: 200, response: recommendationResponse })
    cy.task('getStatuses', { statusCode: 200, response: [] })
    cy.visit(`${sharedPaths.recommendations}/${recommendationId}/trigger-leading-to-recall`)
    cy.clickButton('Continue')
    cy.assertErrorMessage({
