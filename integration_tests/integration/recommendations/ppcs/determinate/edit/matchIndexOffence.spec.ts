  ...
  describe('Page Data', () => {
    ...
    describe('Initial page load', () => {
      ...
      it('Loads the correct page data with empty inputs', () => {
        ...
        testPageContent(selectedNomisOffence, autocompleteId, textAreaId, ppudIndexOffenceReferenceListResponse.values)
      })
    })
...
function testPageContent(
  ...
  cy.get('@offenceDescriptionSelectWrapper')
    ...
    .should('contain.text', 'Now select the nearest matching offence from the list in PPUD')
