Feature: Recall (indeterminate) with offence details feature flag enabled

  Background:
    Given Maria signs in to the case overview for CRN "1" with feature flag "flagRecommendationOffenceDetails" enabled
...
#    EXTENDED SENTENCE / EMERGENCY / NOT IN CUSTODY
    ...
    And Maria downloads the Part A and confirms the indeterminate recall with details
