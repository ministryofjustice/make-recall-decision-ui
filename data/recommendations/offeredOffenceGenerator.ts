...
const generateInternal = (options?: OfferedOffenceOptions): OfferedOffence => ({
  ...
  sentenceEndDate:
    options?.sentenceEndDate === 'none' ? undefined : (options?.sentenceEndDate ?? faker.date.future().toISOString()),
