...
import chargedWithOffenceController from '../../controllers/recommendation/chargedWithOffenceController'
...
export const ppRecommendationRoutes: RouteDefinition[] = [
  ...
  },
  {
    ...
    handler: chargedWithOffenceController.get,
  },
  {
    ...ppPostTemplate,
    path: `${RECOMMENDATION_PREFIX}/${ppPaths.chargedWithOffence}`,
    handler: chargedWithOffenceController.post,
  },
