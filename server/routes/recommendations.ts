...
import editMinuteController from '../controllers/recommendation/editMinuteController'
...
ppcsRouteBuilder.get('edit-minute', editMinuteController.get)
ppcsRouteBuilder.post('edit-minute', editMinuteController.post)
