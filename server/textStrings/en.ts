export const strings = {
  errors: {
    ...
    noLocalPoliceEmail: 'Enter an email address',
    invalidLocalPoliceEmail: 'Enter a valid email address',
    noLocalPolicePhone: 'Enter a phone number',
    invalidLocalPolicePhone: 'Enter a valid phone number',
    noLocalPoliceFax: 'Enter a fax number',
    invalidLocalPoliceFax: 'Enter a valid fax number',
  },
  pageHeadings: {
