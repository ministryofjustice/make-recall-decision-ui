export const strings: Record<string, Record<string, string>> = {
  errors: {
    ...
    missingOdmName: 'You must provide an out-of-hours manager name',
    missingRationaleCheck: 'Choose an option',
    missingCustodyType: 'Select custody type',
    missingPoliceForce: 'Select police force',
    missingMappaLevel: 'Select MAPPA level',
    missingGender: 'Select gender',
    missingEthnicity: 'Select ethnicity',
    missingLegislationReleasedUnder: 'Select legislation',
    missingReleasingPrison: 'Select releasing prison',
    missingProbationArea: 'Select probation area',
    ...
    missingTriggerLeadingToRecall: 'You must explain what has made you consider recalling {{ fullName }}',
