export const strings = {
  errors: {
    ...
    noRecallRationale: 'You must explain why you are not recalling {{ fullName }}',
    noRecallPopProgressMade: 'You must explain what progress {{ fullName }} has made so far',
    noRecallFutureExpectations: 'You must explain the actions you have agreed for the future',
