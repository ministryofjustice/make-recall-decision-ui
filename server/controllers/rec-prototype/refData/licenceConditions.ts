export const standardLicenceConditionsRefData = [
  ...
  },
  {
    ...
    text: 'Reside permanently at an address approved by the supervising officer and obtain prior permission of the supervising officer for any stay of one or more nights at a different address',
  },
  {
    id: 6,
    value: 'APPROVED_WORK',
  ...
  },
  {
    id: 7,
    value: 'APPROVED_WORK',
    text: 'Not to travel outside the United Kingdom, the Channel Islands or the Isle of Man except with the prior permission of your supervising officer or for the purpose of immigration deportation or removaL',
  },
  {
    id: 8,
    value: 'NAME_CHANGE',
