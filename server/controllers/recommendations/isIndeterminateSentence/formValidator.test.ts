...
describe('validateIsIndeterminateSentence', () => {
  ...
  it('sets indeterminate type to NO, extended sentence to null and redirects to recall type page if answer is No', async () => {
    const requestBody = {
  ...
  it('resets indeterminate type to null, extended sentence to null and redirects to indeterminate sentence type, if answer is Yes', async () => {
    const requestBody = {
