...
const inputDisplayValuesIntegratedOffenderManagement = ({ errors = {}, apiValues }: InputDisplayValuesArgs) => {
...
export default inputDisplayValuesIntegratedOffenderManagement
